...
<?php
	...
	foreach($data as $key)
	{
		...
		<br>Posted by <?php echo$key['nama'];?>
			<br><a href="proses/news/delete.php?id=<?php echo$key['id'];?>"><button style="float-right;" type="submit" onclick="return confirm('Hapus Berita <?php echo$key['judul'];?>')">Delete News</button></a>
		</div>
		<hr>
		<?php
	}
